...
issue and make sure someone agrees that it’s needed. If you’ve found a
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("Moohan/octopusR", fork = TRUE)`.
...
Code of Conduct](https://moohan.github.io/octopusR/CODE_OF_CONDUCT.md).
