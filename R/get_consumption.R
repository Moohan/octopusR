...
get_consumption <- function(
  ...
  # ⚡ Bolt: Replaced do.call(rbind, ...) with a more performant method.
  # `vctrs::vec_rbind()` is significantly faster and more memory-efficient
  # for row-binding many data frames, especially when `data.table` is not
  # available. The `!!!` operator splices the list of data frames into
  # individual arguments for the function.
