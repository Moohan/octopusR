...
get_consumption <- function(
  ...
  # If data.table is available, it's the fastest way to bind the rows.
  # If not, vctrs::vec_rbind() is a faster and more robust alternative to
  # the base `do.call(rbind, ...)` fallback.
