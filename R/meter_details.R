...
#' @param include_gsp (boolean, default: TRUE) Whether to include the Grid
#' Supply Point (GSP) in the meter details. Setting to FALSE avoids an
#' extra API call.
#' @noRd
get_meter_details <-
  function(
