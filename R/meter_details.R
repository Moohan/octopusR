...
#' @note Replacing `ifelse()` with logical indexing for NA replacement in
#' `combine_consumption` provides a significant performance boost (~3-4x speedup
#' and ~70% memory reduction), as verified by `bench::mark()`.
#' @export
